...
void DispatchServerCommand(app::Command * apCommandObj, CommandId aCommandId, EndpointId aEndpointId, TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled              = false;
    {
        ...
        case ZCL_LOCK_DOOR_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 0: {
                    ...
                    PIN                     = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                default:
                    // Unsupported tag, ignore it.
            ...
            {
                // TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
                wasHandled = emberAfDoorLockClusterLockDoorCallback(apCommandObj, PIN);
            }
            break;
        }
        ...
        case ZCL_SET_PIN_COMMAND_ID: {
            ...
            {
                // TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
                wasHandled = emberAfDoorLockClusterSetPinCallback(apCommandObj, userId, userStatus, userType, pin);
            }
            break;
        }
        case ZCL_SET_RFID_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 3: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    id                      = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                default:
                    // Unsupported tag, ignore it.
            ...
            {
                // TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
                wasHandled = emberAfDoorLockClusterSetRfidCallback(apCommandObj, userId, userStatus, userType, id);
            }
            break;
        }
        ...
        case ZCL_UNLOCK_DOOR_COMMAND_ID: {
            ...
            {
                // TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
                wasHandled = emberAfDoorLockClusterUnlockDoorCallback(apCommandObj, PIN);
            }
            break;
        }
        case ZCL_UNLOCK_WITH_TIMEOUT_COMMAND_ID: {
            ...
            {
                // TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
                wasHandled = emberAfDoorLockClusterUnlockWithTimeoutCallback(apCommandObj, timeoutInSeconds, pin);
            }
            break;
        }
        default: {
...
void DispatchServerCommand(app::Command * apCommandObj, CommandId aCommandId, EndpointId aEndpointId, TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled              = false;
    {
        ...
        case ZCL_ADD_GROUP_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 1: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    groupName               = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                default:
                    // Unsupported tag, ignore it.
            ...
            {
                // TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
                wasHandled = emberAfGroupsClusterAddGroupCallback(apCommandObj, groupId, groupName);
            }
            break;
        }
        case ZCL_ADD_GROUP_IF_IDENTIFYING_COMMAND_ID: {
            ...
            {
                // TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
                wasHandled = emberAfGroupsClusterAddGroupIfIdentifyingCallback(apCommandObj, groupId, groupName);
            }
            break;
        }
        ...
        case ZCL_ADD_THREAD_NETWORK_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 0: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    operationalDataset      = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 1:
                    TLVUnpackError = aDataTlv.Get(breadcrumb);
        ...
        case ZCL_ADD_WI_FI_NETWORK_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 0: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    ssid                    = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 1: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    credentials             = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 2:
                    TLVUnpackError = aDataTlv.Get(breadcrumb);
        ...
        case ZCL_DISABLE_NETWORK_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 0: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    networkID               = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 1:
                    TLVUnpackError = aDataTlv.Get(breadcrumb);
        ...
        case ZCL_APPLY_UPDATE_REQUEST_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 0: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    updateToken             = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 1:
        ...
        case ZCL_QUERY_IMAGE_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 6: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    location                = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 7:
                ...
                case 8: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    metadataForServer       = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                default:
                    // Unsupported tag, ignore it.
            ...
            if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError && 9 == validArgumentCount)
            {
                ...
                wasHandled = emberAfOtaSoftwareUpdateServerClusterQueryImageCallback(
                    apCommandObj, vendorId, productId, imageType, hardwareVersion, currentVersion, protocolsSupported, location,
        ...
        case ZCL_ADD_OP_CERT_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 0: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    NOC                     = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 1: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    ICACertificate          = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 2: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    IPKValue                = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 3:
        ...
        case ZCL_OP_CSR_REQUEST_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 0: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    CSRNonce                = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                default:
                    // Unsupported tag, ignore it.
        ...
        case ZCL_UPDATE_FABRIC_LABEL_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 0: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    Label                   = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                default:
                    // Unsupported tag, ignore it.
        ...
        case ZCL_ADD_SCENE_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 3: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    sceneName               = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 4:
                    // Just for compatibility, we will add array type support in IM later.
            ...
            {
                // TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
                wasHandled = emberAfScenesClusterAddSceneCallback(apCommandObj, groupId, sceneId, transitionTime, sceneName,
                                                                  extensionFieldSets);
            }
            break;
        }
