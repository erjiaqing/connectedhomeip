...
// Enum for NetworkProvisioningError
typedef enum
{
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_SUCCESS                  = 0,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_OUT_OF_RANGE             = 1,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_BOUNDS_EXCEEDED          = 2,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_NETWORK_ID_NOT_FOUND     = 3,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_DUPLICATE_NETWORK_ID     = 4,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_NETWORK_NOT_FOUND        = 5,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_REGULATORY_ERROR         = 6,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_AUTH_FAILURE             = 7,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_UNSUPPORTED_SECURITY     = 8,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_OTHER_CONNECTION_FAILURE = 9,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_IPV6_FAILED              = 10,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_IP_BIND_FAILED           = 11,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_LABEL9                   = 12,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_LABEL10                  = 13,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_LABEL11                  = 14,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_LABEL12                  = 15,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_LABEL13                  = 16,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_LABEL14                  = 17,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_LABEL15                  = 18,
    EMBER_ZCL_NETWORK_PROVISIONING_ERROR_UNKNOWN_ERROR            = 19,
} EmberAfNetworkProvisioningError;
...
#define EMBER_AF_SHADE_CLOSURE_STATUS_UNENCRYPTED (1)
#define EMBER_AF_SHADE_CLOSURE_STATUS_UNENCRYPTED_OFFSET (0)
#define EMBER_AF_SHADE_CLOSURE_STATUS_WEP_PERSONAL (2)
#define EMBER_AF_SHADE_CLOSURE_STATUS_WEP_PERSONAL_OFFSET (1)
#define EMBER_AF_SHADE_CLOSURE_STATUS_WPA_PERSONAL (4)
#define EMBER_AF_SHADE_CLOSURE_STATUS_WPA_PERSONAL_OFFSET (2)
#define EMBER_AF_SHADE_CLOSURE_STATUS_WPA2_PERSONAL (8)
#define EMBER_AF_SHADE_CLOSURE_STATUS_WPA2_PERSONAL_OFFSET (3)
#define EMBER_AF_SHADE_CLOSURE_STATUS_WPA3_PERSONAL (16)
#define EMBER_AF_SHADE_CLOSURE_STATUS_WPA3_PERSONAL_OFFSET (4)
