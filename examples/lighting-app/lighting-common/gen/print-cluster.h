...
#if defined(ZCL_USING_NWPROV_CLUSTER_SERVER) || defined(ZCL_USING_NWPROV_CLUSTER_CLIENT)
#define CHIP_PRINTCLUSTER_NWPROV_CLUSTER { ZCL_NWPROV_CLUSTER_ID, 39321, "Network Provisioning" },
#else
#define CHIP_PRINTCLUSTER_NWPROV_CLUSTER
#endif
...
#define CLUSTER_IDS_TO_NAMES                                                                                                       \
    ...
    CHIP_PRINTCLUSTER_NWPROV_CLUSTER                                                                                               \
