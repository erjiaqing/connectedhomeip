                                                          ...
                                                          Callback::Cancelable * onFailureCallback)
{
    ...
    for (size_t i = 0; i < count && CHIP_NO_ERROR == (err = reader.Next()); i++)
    {
        SuccessOrExit(reader.GetObject(data[i]));
    }
    SuccessOrExit(err);
    // If we have exactly count elements, we should not see any errors above, but should meet an error exactly after we iterated all
    // elements.
                                                                ...
                                                                Callback::Cancelable * onFailureCallback)
{
    ...
    for (size_t i = 0; i < count && CHIP_NO_ERROR == (err = reader.Next()); i++)
    {
        ...
        SuccessOrExit(reader.GetDataPtr(dataPtr));
        data[i] = chip::ByteSpan(dataPtr, reader.GetLength());
    }
    SuccessOrExit(err);
    // If we have exactly count elements, we should not see any errors above, but should meet an error exactly after we iterated all
    // elements.
...
bool emberAfMediaPlaybackClusterMediaFastForwardResponseCallback(chip::app::CommandSender * commandObj, uint8_t mediaPlaybackStatus)
{
...
bool emberAfMediaPlaybackClusterMediaSkipForwardResponseCallback(chip::app::CommandSender * commandObj, uint8_t mediaPlaybackStatus)
{
