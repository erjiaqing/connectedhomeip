...
public:
    ...
    CHIP_ERROR OnResubscriptionNeeded(ReadClient * apReadClient, CHIP_ERROR aTerminationCause) override
    {
        ...
        gOnResubscriptionAttemptedCallback(mAppContext, aTerminationCause, apReadClient->ComputeTimeTillNextSubscription());
    ...
    void OnError(CHIP_ERROR aError) override { gOnReadErrorCallback(mAppContext, aError); }
...
public:
    ...
    {
        gOnWriteErrorCallback(mAppContext, aProtocolError);
    }
