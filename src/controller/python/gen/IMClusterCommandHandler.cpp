...
void DispatchClientCommand(app::Command * apCommandObj, CommandId aCommandId, EndpointId aEndpointId, TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled              = false;
    {
        ...
        case ZCL_LAUNCH_CONTENT_RESPONSE_COMMAND_ID: {
            ...
            {
                // TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
                wasHandled = emberAfContentLaunchClusterLaunchContentResponseCallback(apCommandObj, data, contentLaunchStatus);
            }
            break;
        }
        case ZCL_LAUNCH_URL_RESPONSE_COMMAND_ID: {
            ...
            {
                // TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
                wasHandled = emberAfContentLaunchClusterLaunchURLResponseCallback(apCommandObj, data, contentLaunchStatus);
            }
            break;
        }
        default: {
        ...
        case ZCL_GET_RFID_RESPONSE_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 3: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    rfid                    = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                default:
                    // Unsupported tag, ignore it.
        ...
        case ZCL_ARM_FAIL_SAFE_RESPONSE_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 1: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    debugText               = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                default:
                    // Unsupported tag, ignore it.
        ...
        case ZCL_OP_CSR_RESPONSE_COMMAND_ID: {
            ...
            while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR)
            {
                ...
                case 0: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    CSR                     = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 1:
                ...
                case 3: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    VendorReserved1         = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 4: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    VendorReserved2         = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 5: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    VendorReserved3         = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                case 6: {
                    const uint8_t * rawData = nullptr;
                    TLVUnpackError          = aDataTlv.GetDataPtr(rawData);
                    Signature               = chip::ByteSpan(rawData, aDataTlv.GetLength());
                }
                break;
                default:
                    // Unsupported tag, ignore it.
