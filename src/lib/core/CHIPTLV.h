...
public:
    ...
    /**
     * Retreves a struct from TLV.
     */
    template <typename T>
    CHIP_ERROR GetObject(T & data)
    {
        return DecodeStruct(data, *this);
    }
...
public:
    ...
    /**
     * template for encode a encodable structs.
     */
    template <typename T>
    CHIP_ERROR PutObject(uint64_t tag, const T & data)
    {
        return EncodeStruct(data, *this, tag);
    }
