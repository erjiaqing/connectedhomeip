...
public:
    ...
    CHIP_ERROR SetThreadProvision(const uint8_t * operationalDataset, const uint32_t operationalDatasetLen);
...
inline CHIP_ERROR ThreadStackManager::SetThreadProvision(const uint8_t * operationalDataset, const uint32_t operationalDatasetLen)
{
