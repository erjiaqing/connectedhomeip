...
CHIP_ERROR ThreadStackManagerImpl::_SetThreadProvision(const uint8_t * operationalDataset, const uint32_t operationalDatasetLen)
{
...
{
    return (mNetworkInfo.ThreadNetworkName[0] != '\0') || (mOperationalDatasetTlv.size() > 0);
}
