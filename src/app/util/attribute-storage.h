...
// depending on server toggle.
// Returns app::ConcreteAttributePath::kInvalidClusterId if cluster does not exists.
...
// Returns 0 if the cluster or endpoint do not exists.
...
// of or iterate over the attributes.
// Returns UINT16_MAX if the attribute, cluster or endpoint do not exists.
...
// attributes.
// Returns chip::ConcreteAttributePath::kInvalidAttributeId if the attribute does not exists.
