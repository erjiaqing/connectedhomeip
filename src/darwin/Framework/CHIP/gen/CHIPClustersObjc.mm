...
public:
    ...
    static void CallbackFn(void * context, uint64_t value)
    {
        ...
        if (callback && callback->mQueue) {
            dispatch_async(callback->mQueue, ^{
                callback->mHandler(nil, @ { @"value" : [NSNumber numberWithUnsignedChar:static_cast<uint8_t>(value)] });
                if (!callback->mKeepAlive) {
                    callback->Cancel();
                    delete callback;
                }
...
public:
    ...
    static void CallbackFn(void * context, int64_t value)
    {
        ...
        if (callback && callback->mQueue) {
            dispatch_async(callback->mQueue, ^{
                callback->mHandler(nil, @ { @"value" : [NSNumber numberWithChar:static_cast<int8_t>(value)] });
                if (!callback->mKeepAlive) {
                    callback->Cancel();
                    delete callback;
                }
...
public:
    ...
    static void CallbackFn(void * context, uint64_t value)
    {
        ...
        if (callback && callback->mQueue) {
            dispatch_async(callback->mQueue, ^{
                callback->mHandler(nil, @ { @"value" : [NSNumber numberWithUnsignedShort:static_cast<uint16_t>(value)] });
                if (!callback->mKeepAlive) {
                    callback->Cancel();
                    delete callback;
                }
...
public:
    ...
    static void CallbackFn(void * context, int64_t value)
    {
        ...
        if (callback && callback->mQueue) {
            dispatch_async(callback->mQueue, ^{
                callback->mHandler(nil, @ { @"value" : [NSNumber numberWithShort:static_cast<int16_t>(value)] });
                if (!callback->mKeepAlive) {
                    callback->Cancel();
                    delete callback;
                }
...
public:
    ...
    static void CallbackFn(void * context, uint64_t value)
    {
        ...
        if (callback && callback->mQueue) {
            dispatch_async(callback->mQueue, ^{
                callback->mHandler(nil, @ { @"value" : [NSNumber numberWithUnsignedLong:static_cast<uint32_t>(value)] });
                if (!callback->mKeepAlive) {
                    callback->Cancel();
                    delete callback;
                }
...
public:
    ...
    static void CallbackFn(void * context, int64_t value)
    {
        ...
        if (callback && callback->mQueue) {
            dispatch_async(callback->mQueue, ^{
                callback->mHandler(nil, @ { @"value" : [NSNumber numberWithLong:static_cast<int32_t>(value)] });
                if (!callback->mKeepAlive) {
                    callback->Cancel();
                    delete callback;
                }
